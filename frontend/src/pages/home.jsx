...
function home() {
  ...
  return (
    <div className="flex flex-col items-center justify-center gap-4 w-full h-full">
      <button className="relative flex items-center justify-center w-56 sm:w-60 h-12 sm:h-14 overflow-hidden rounded-full bg-[#0E0E10] hover:bg-[#121214] transition-all duration-300">
        <div className="flex items-center gap-3">
          <Github className="text-[#83F180] w-4 h-4 sm:w-5 sm:h-5" />
          <span className="text-white font-bold text-sm sm:text-base">
            Proudly Open Source
          </span>
        </div>
        <div
          className="absolute inline-flex items-center justify-center rounded-full p-[1.4px] w-56 sm:w-60 h-12 sm:h-14"
          style={{
            background:
    ...
    `,
      ...
      <p className="text-white text-center text-sm sm:text-lg w-2/3 sm:w-3/4 md:w-2/4 lg:w-2/5 xl:w-1/3 2xl:w-2/7 pt-2 first-letter:uppercase">
